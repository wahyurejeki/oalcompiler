    ...
    function loadLibrarySample() {
        ...
        state = {
            ...
            routes: [
                ...
                { id: "r_2", method: "get", path: "/books/{id}", controller: "BookController", action: "showBookAction", middlewares: ["AuthMiddleware"] },
                { id: "r_3", method: "post", path: "/books", controller: "BookController", action: "createBookAction", middlewares: ["AuthMiddleware"] },
                { id: "r_4", method: "put", path: "/books/{id}", controller: "BookController", action: "updateBookAction", middlewares: ["AuthMiddleware"] },
                { id: "r_5", method: "delete", path: "/books/{id}", controller: "BookController", action: "deleteBookAction", middlewares: ["AuthMiddleware"] },
                ...
                { id: "r_9", method: "get", path: "/categories/{id}", controller: "CategoryController", action: "showCategoryAction", middlewares: [] },
                { id: "r_10", method: "post", path: "/categories", controller: "CategoryController", action: "createCategoryAction", middlewares: [] },
                { id: "r_11", method: "put", path: "/categories/{id}", controller: "CategoryController", action: "updateCategoryAction", middlewares: [] },
                { id: "r_12", method: "delete", path: "/categories/{id}", controller: "CategoryController", action: "deleteCategoryAction", middlewares: [] },
                { id: "r_13", method: "get", path: "/publishers", controller: "PublisherController", action: "listPublishersAction", middlewares: [] },
                { id: "r_14", method: "get", path: "/publishers/{id}", controller: "PublisherController", action: "showPublisherAction", middlewares: [] },
                { id: "r_15", method: "post", path: "/publishers", controller: "PublisherController", action: "createPublisherAction", middlewares: [] },
                { id: "r_16", method: "put", path: "/publishers/{id}", controller: "PublisherController", action: "updatePublisherAction", middlewares: [] },
                { id: "r_17", method: "delete", path: "/publishers/{id}", controller: "PublisherController", action: "deletePublisherAction", middlewares: [] },
                { id: "r_18", method: "get", path: "/authors", controller: "AuthorController", action: "listAuthorsAction", middlewares: [] },
                { id: "r_19", method: "get", path: "/authors/{id}", controller: "AuthorController", action: "showAuthorAction", middlewares: [] },
                { id: "r_20", method: "post", path: "/authors", controller: "AuthorController", action: "createAuthorAction", middlewares: [] },
                { id: "r_21", method: "put", path: "/authors/{id}", controller: "AuthorController", action: "updateAuthorAction", middlewares: [] },
                { id: "r_22", method: "delete", path: "/authors/{id}", controller: "AuthorController", action: "deleteAuthorAction", middlewares: [] },
                { id: "r_23", method: "get", path: "/members", controller: "MemberController", action: "listMembersAction", middlewares: [] },
                { id: "r_24", method: "get", path: "/members/{id}", controller: "MemberController", action: "showMemberAction", middlewares: [] },
                { id: "r_25", method: "post", path: "/members", controller: "MemberController", action: "registerMemberAction", middlewares: [] },
                { id: "r_26", method: "put", path: "/members/{id}", controller: "MemberController", action: "updateMemberAction", middlewares: [] },
                { id: "r_27", method: "delete", path: "/members/{id}", controller: "MemberController", action: "deleteMemberAction", middlewares: [] },
                ...
                { id: "r_29", method: "get", path: "/reservations/{id}", controller: "ReservationController", action: "showReservationAction", middlewares: ["AuthMiddleware"] },
                ...
                { id: "r_31", method: "delete", path: "/reservations/{id}", controller: "ReservationController", action: "cancelReservationAction", middlewares: ["AuthMiddleware"] },
                { id: "r_32", method: "get", path: "/fines", controller: "FineController", action: "listFinesAction", middlewares: ["AuthMiddleware"] },
                { id: "r_33", method: "get", path: "/fines/{id}", controller: "FineController", action: "showFineAction", middlewares: ["AuthMiddleware"] },
